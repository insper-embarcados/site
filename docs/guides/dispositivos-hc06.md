...
A sequência de inicialização e configuração automática é realizada pela função `hc06_config`, chamada pela `init_task` :
...
Caso você não saiba como parear o HC-06 com o seu respectivo sistema operacional, siga o tutorial específico:
