...
Também vamos ver como usar o PWM para gerat um pulso no pino usando modulação por largura de pulso e controlar por exemplo a luminosidade de um LED.

## Leitura obrigaratória

Ler sobre o I2C e PWM:
