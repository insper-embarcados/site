...
> Consulte o repositório de onde o diagrama foi extraído, pois ele contém informações relevantes e aprofundadas:
>
> * [Embedded Systems Engineering Roadmap](https://github.com/m3y54m/Embedded-Engineering-Roadmap)

Muitos dos tópicos apresentados no mapa serão abordados ao longo dos **laboratórios, experts e da APS**. Ainda assim, é importante destacar que diversos conteúdos ficarão fora do escopo, dada a amplitude da área.

## Módulos

Neste primeiro laboratório expert, estarão disponíveis **três módulos**, dos quais cada aluno deverá escolher um:

* **LCD**: módulo que ensina como utilizar um display LCD colorido com suporte a touch.
